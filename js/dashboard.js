  // 1. Grade padrão de referência
    ...
    const modoEditarAtivo =
        document.getElementById('checkEditMode')?.checked || false;
    ...
    aulasDoDia.forEach((aula, indice) => {
        ...
        if (modoEditarAtivo) {
            el.style.border = '2px dashed #f97316';
        }
        ...
        el.innerHTML = `
            ...
            ${
                modoEditarAtivo
                    ? '<span class="material-symbols-outlined" style="color:#f97316;">edit</span>'
                    : ''
            }
        `;
